...
jQuery(document).ready(function ($) {
  ...
  function animateHeadline($headlines) {
    ...
    $headlines.each(function () {
      ...
      if (headline.hasClass("loading-bar")) {
        ...
        setTimeout(function () {
          headline.find(".banner-words-wrapper").addClass("is-loading");
        }, barWaiting);
      } else if (headline.hasClass("clip")) {
        var spanWrapper = headline.find(".banner-words-wrapper"),
          newWidth = spanWrapper.width() + 10;
        spanWrapper.css("width", newWidth);
      } else if (!headline.hasClass("type")) {
        var words = headline.find(".banner-words-wrapper b"),
          width = 0;
        words.each(function () {
          var wordWidth = $(this).width();
          if (wordWidth > width) width = wordWidth;
        });
        headline.find(".banner-words-wrapper").css("width", width);
      }
      setTimeout(function () {
  ...
  function hideWord($word) {
    ...
    if ($word.parents(".banner-headline").hasClass("type")) {
      var parentSpan = $word.parent(".banner-words-wrapper");
    ...
    } else if ($word.parents(".banner-headline").hasClass("letters")) {
      var bool =
    ...
    } else if ($word.parents(".banner-headline").hasClass("loading-bar")) {
      $word.parents(".banner-words-wrapper").removeClass("is-loading");
      switchWord($word, nextWord);
      setTimeout(function () {
        hideWord(nextWord);
      }, barAnimationDelay);
      setTimeout(function () {
        $word.parents(".banner-words-wrapper").addClass("is-loading");
      }, barWaiting);
    } else {
      switchWord($word, nextWord);
      setTimeout(function () {
  ...
  function showLetter($letter, $word, $bool, $duration) {
    ...
    if (!$letter.is(":last-child")) {
      ...
      if ($word.parents(".banner-headline").hasClass("type")) {
        setTimeout(function () {
          $word.parents(".banner-words-wrapper").addClass("waiting");
        }, 200);
      }
      if (!$bool) {
        setTimeout(function () {
